...
ROWS = [
    ...
    (9,  "Hkv kv头数", "全局 num_key_value_heads；TP 后 Hkv_local=max(1,Hkv//TP) [HF config / vLLM MiniMax TP]"),
    ...
    (42, "单个token占用的kv cache(MiB)", "L × 2 × Hkv_local × D × dtype [AttentionSpec.real_page_size_bytes / block_size]"),
